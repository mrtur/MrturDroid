ArchiDroid_FstrimData - From Android 4.3 I'm happy to include fstrim "on demand" to MrturDroid. By executing this script you call fstrim() on /data partition. If you want to learn more google "TRIM".
